...
# Note: The Structure and Union metaclasses check for the *presence* (not the
# value!) of a _swapped_bytes_ attribute to determine the bit order in
# structures/unions containing bit fields.
